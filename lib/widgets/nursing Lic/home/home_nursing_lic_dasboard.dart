...
import '../../../providers/admin/beds_admin_provider.dart';
import '../../../providers/admin/rooms_admin_provider.dart';
import '../../../style/app_style.dart';


class HomeSupervisorDashBoard extends StatefulWidget {
  const HomeSupervisorDashBoard({super.key});

  @override
  State<HomeSupervisorDashBoard> createState() => _HomeSupervisorDashBoardState();
}

class _HomeSupervisorDashBoardState extends State<HomeSupervisorDashBoard> {
  int? selectedRoomId;
